...
local pagesModule = LibStub("AngrySparks-Pages") --[[@as PagesModule]]
            ...
            table.insert(categories,
                {
                    ...
                    func = function(frame, eid, catid) pagesModule:AssignCategory(frame, entryId, cat.Id) end,
                    arg1 = entryId,
                    arg2 = cat.Id
                })
        end
...
function AngrySparks:GetWindow()
...
function AngrySparks:CreateWindow()
    ...
    button_revert:SetCallback("OnClick", function() pagesModule:RevertPage() end)
    ...
    button_clear:SetCallback("OnClick", function() pagesModule:ClearPage() end)
...
function AngrySparks:OnEnable()
    ...
    self:ScheduleTimer(function() AngrySparks:AfterEnable() end, 4)
